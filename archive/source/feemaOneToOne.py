# ---------------------------------------------------------------------------
# feemaOneToOne.py
# Created on: 2012-09-24 14:27:50.00000
#   (generated by ArcGIS/ModelBuilder)
# Usage: feemaOneToOne <SA_STEWARD_TNC_LANDS> <feema1to1> 
# Description: 
# ---------------------------------------------------------------------------
...
feema1to1 = arcpy.GetParameterAsText(1)
if feema1to1 == '#' or not feema1to1:
    feema1to1 = "feema1to1" # provide a default value if unspecified
...
v26 = v1
v27 = v26
SA_STEWARD_TNC_LANDS__2_ = v27

# Process: Join
arcpy.AddJoin_management(SA_STEWARD_TNC_LANDS, "MA_IFMS_ID", feema1to1, "MA_IFMS_ID", "KEEP_COMMON")
...
arcpy.CalculateField_management(v2, "SA_STEWARD.TNC_LANDS.AREANAM", "[feema1to1.AREANAM] + \" Fee\"", "VB", "")
...
# Process: CLSTRANSDA
arcpy.CalculateField_management(v14, "SA_STEWARD.TNC_LANDS.CLSTRANSDA", "[feema1to1.CLSTRANSDA]", "VB", "")

# Process: Select 3
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "SA_STEWARD.TNC_LANDS.MA_IFMS_ID IS NOT NULL AND SA_STEWARD.TNC_LANDS.TR_IFMS_ID IS NULL")

# Process: MABR_NAME
arcpy.CalculateField_management(v16, "SA_STEWARD.TNC_LANDS.MABR_NAME", "[feema1to1.MABR_NAME]", "VB", "")
...
# Process: CLS_ACRES
arcpy.CalculateField_management(v24, "SA_STEWARD.TNC_LANDS.CLS_ACRES", "[feema1to1.CLS_ACRES]", "VB", "")

# Process: select 5
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "SA_STEWARD.TNC_LANDS.MA_IFMS_ID IS NOT NULL AND SA_STEWARD.TNC_LANDS.TR_IFMS_ID IS NULL")

# Process: TR_IFMAS_ID
arcpy.CalculateField_management(v26, "SA_STEWARD.TNC_LANDS.TR_IFMS_ID", "[feema1to1.TR_IFMS_ID]", "VB", "")

# Process: Remove Join
arcpy.RemoveJoin_management(v27, "feema1to1")

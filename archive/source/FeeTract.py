# ---------------------------------------------------------------------------
# FeeTract.py
# Created on: 2012-09-24 14:28:33.00000
#   (generated by ArcGIS/ModelBuilder)
# Usage: FeeTract <SA_STEWARD_TNC_LANDS> <feetracts> 
# Description: 
# ---------------------------------------------------------------------------
...
feetracts = arcpy.GetParameterAsText(1)
if feetracts == '#' or not feetracts:
    feetracts = "feetracts" # provide a default value if unspecified
...
# Process: Add Join
arcpy.AddJoin_management(SA_STEWARD_TNC_LANDS, "TR_IFMS_ID", feetracts, "TR_IFMS_ID", "KEEP_COMMON")
...
arcpy.CalculateField_management(v2, "SA_STEWARD.TNC_LANDS.AREANAM", "[feetracts.AREANAM] + \" Fee\"", "VB", "")
...
# Process: PROTMECH
arcpy.CalculateField_management(v11_1_, "SA_STEWARD.TNC_LANDS.PROTMECH", "\"Fee-simple ownership\"", "VB", "")

# Process: 1 = 1 [2]
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "1 = 1")

# Process: CLSTRANSDA
arcpy.CalculateField_management(v15_1_, "SA_STEWARD.TNC_LANDS.CLSTRANSDA", "[feetracts.CLSTRANSDA]", "VB", "")

# Process: 1 = 1 (3)
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "1 = 1")

# Process: TRACT_NAME
arcpy.CalculateField_management(v17_1_, "SA_STEWARD.TNC_LANDS.TRACT_NAME", "[feetracts.TRACT_NAME]", "VB", "")
...
# Process: CLS_ACRES 
arcpy.CalculateField_management(v23_2_, "SA_STEWARD.TNC_LANDS.CLS_ACRES", "[feetracts.CLS_ACRES]", "VB", "")

# Process: 1 = 1 (6)
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "1 = 1")

# Process: MA_IFMS_ID
arcpy.CalculateField_management(v24_1_, "SA_STEWARD.TNC_LANDS.MA_IFMS_ID", "[feetracts.MA_IFMS_ID]", "VB", "")

# Process: Remove Join
arcpy.RemoveJoin_management(v25__3_, "feetracts")

# Process: 1 = 1 (4)
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "1 = 1")

# Process: MABR_NAME
arcpy.CalculateField_management(v17_1___2_, "SA_STEWARD.TNC_LANDS.MABR_NAME", "[feetracts.MABR_NAME]", "VB", "")

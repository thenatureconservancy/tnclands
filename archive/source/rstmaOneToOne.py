# ---------------------------------------------------------------------------
# rstmaOneToOne.py
# Created on: 2012-09-24 14:29:00.00000
#   (generated by ArcGIS/ModelBuilder)
# Usage: rstmaOneToOne <SA_STEWARD_TNC_LANDS> <rstma1to1> 
# Description: 
# ---------------------------------------------------------------------------
...
rstma1to1 = arcpy.GetParameterAsText(1)
if rstma1to1 == '#' or not rstma1to1:
    rstma1to1 = "rstma1to1" # provide a default value if unspecified
...
v24__2_ = v1
v25__2_ = v24__2_
SA_STEWARD_TNC_LANDS__3_ = v25__2_

# Process: Add Join
arcpy.AddJoin_management(SA_STEWARD_TNC_LANDS, "MA_IFMS_ID", rstma1to1, "MA_IFMS_ID", "KEEP_COMMON")
...
arcpy.CalculateField_management(v2, "SA_STEWARD.TNC_LANDS.AREANAM", "[rstma1to1.AREANAM] + \" Easement\"", "VB", "")
...
# Process: PROTMECH
arcpy.CalculateField_management(v12, "SA_STEWARD.TNC_LANDS.PROTMECH", "\"Deed Restriction\"", "VB", "")

# Process: Select 2
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "SA_STEWARD.TNC_LANDS.MA_IFMS_ID IS NOT NULL AND SA_STEWARD.TNC_LANDS.TR_IFMS_ID IS NULL")

# Process: CLSTRANDA
arcpy.CalculateField_management(v14, "SA_STEWARD.TNC_LANDS.CLSTRANSDA", "[rstma1to1.CLSTRANSDA]", "VB", "")

# Process: Select 3
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "SA_STEWARD.TNC_LANDS.MA_IFMS_ID IS NOT NULL AND SA_STEWARD.TNC_LANDS.TR_IFMS_ID IS NULL")

# Process: MABR_NAME
arcpy.CalculateField_management(v16, "SA_STEWARD.TNC_LANDS.MABR_NAME", "[rstma1to1.MABR_NAME]", "VB", "")
...
# Process: CLS_ACRES 
arcpy.CalculateField_management(v24, "SA_STEWARD.TNC_LANDS.CLS_ACRES", "[rstma1to1.CLS_ACRES]", "VB", "")

# Process: Select 5
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "SA_STEWARD.TNC_LANDS.MA_IFMS_ID IS NOT NULL AND SA_STEWARD.TNC_LANDS.TR_IFMS_ID IS NULL")

# Process: TR_IFMS_ID
arcpy.CalculateField_management(v24__2_, "SA_STEWARD.TNC_LANDS.TR_IFMS_ID", "[rstma1to1.TR_IFMS_ID]", "VB", "")

# Process: Remove Join
arcpy.RemoveJoin_management(v25__2_, "rstma1to1")

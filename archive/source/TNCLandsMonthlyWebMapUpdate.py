...
EXTERNALGDBPATH =       'D:/GIS_Data/jplatt/Workspace/Data/NACR/TNC_Lands/Archive/Data/Web_Map/External/{}'.format(DATESTRING)
...
INTERNALGDBPATH =       'D:/GIS_Data/jplatt/Workspace/Data/NACR/TNC_Lands/Archive/Data/Web_Map/Internal/{}'.format(DATESTRING)
...
EXTERNALWEBFIELDLIST = [('STATE', 'TEXT', '#', '#', '2', '', 'NULLABLE', 'NON_REQUIRED', 'tnc_STATE'),
                        ...
                        #The names and type of the next two fields have been altered for the web application
                        #('TR_ID_TEXT', 'TEXT', '#', '#', '50', '', 'NULLABLE', 'NON_REQUIRED', '#'),
                        #('MA_ID_TEXT', 'TEXT', '#', '#', '50', '', 'NULLABLE', 'NON_REQUIRED', '#'),
                        ('TR_IFMS_ID', 'TEXT', '#', '#', '50', '', 'NULLABLE', 'NON_REQUIRED', '#'),
                        ('MA_IFMS_ID', 'TEXT', '#', '#', '50', '', 'NULLABLE', 'NON_REQUIRED', '#'),

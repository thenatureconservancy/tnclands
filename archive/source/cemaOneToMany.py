# ---------------------------------------------------------------------------
# cemaOneToMany.py
# Created on: 2012-09-24 14:26:03.00000
#   (generated by ArcGIS/ModelBuilder)
# Usage: cemaOneToMany <cema1tomany__2_> <SA_STEWARD_TNC_LANDS__2_> 
# Description: 
# ---------------------------------------------------------------------------
...
# Script arguments
cema1tomany__2_ = arcpy.GetParameterAsText(0)
if cema1tomany__2_ == '#' or not cema1tomany__2_:
    cema1tomany__2_ = "cema1tomany" # provide a default value if unspecified

SA_STEWARD_TNC_LANDS__2_ = arcpy.GetParameterAsText(1)
...
# Process: Add Join
arcpy.AddJoin_management(SA_STEWARD_TNC_LANDS__2_, "MA_IFMS_ID", cema1tomany__2_, "MA_IFMS_ID", "KEEP_COMMON")
...
# Process: AREANAM
arcpy.CalculateField_management(v2, "SA_STEWARD.TNC_LANDS.AREANAM", "[cema1tomany.AREANAM] + \" Easement\"", "VB", "")
...
# Process: CLSTRANSDA
arcpy.CalculateField_management(v14, "SA_STEWARD.TNC_LANDS.CLSTRANSDA", "[cema1tomany.CLSTRANSDA]", "VB", "")

# Process: Select
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "SA_STEWARD.TNC_LANDS.MA_IFMS_ID IS NOT NULL AND SA_STEWARD.TNC_LANDS.TR_IFMS_ID IS NULL")

# Process: MABR_NAME
arcpy.CalculateField_management(v16, "SA_STEWARD.TNC_LANDS.MABR_NAME", "[cema1tomany.MABR_NAME]", "VB", "")
...
# Process: CLS_ACRES
arcpy.CalculateField_management(v24, "SA_STEWARD.TNC_LANDS.CLS_ACRES", "[cema1tomany.CLS_ACRES]", "VB", "")
...
# Process: Remove Join
arcpy.RemoveJoin_management(v5, "cema1tomany")

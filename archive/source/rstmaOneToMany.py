# ---------------------------------------------------------------------------
# rstOneToMany.py
# Created on: 2012-09-24 14:29:14.00000
#   (generated by ArcGIS/ModelBuilder)
# Usage: rstOneToMany <SA_STEWARD_TNC_LANDS> <rstma1tomany> 
# Description: 
# ---------------------------------------------------------------------------
...
rstma1tomany = arcpy.GetParameterAsText(1)
if rstma1tomany == '#' or not rstma1tomany:
    rstma1tomany = "rstma1tomany" # provide a default value if unspecified
...
v24 = v1
v25 = v24
SA_STEWARD_TNC_LANDS__3_ = v25

# Process: Add Join
arcpy.AddJoin_management(SA_STEWARD_TNC_LANDS, "MA_IFMS_ID", rstma1tomany, "MA_IFMS_ID", "KEEP_COMMON")
...
arcpy.CalculateField_management(v2, "SA_STEWARD.TNC_LANDS.AREANAM", "[rstma1tomany.AREANAM] + \" Easement\"", "VB", "")
...
# Process: CLSTRANDA
arcpy.CalculateField_management(v14, "SA_STEWARD.TNC_LANDS.CLSTRANSDA", "[rstma1tomany.CLSTRANSDA]", "VB", "")

# Process: Select 3
arcpy.SelectLayerByAttribute_management(v1, "NEW_SELECTION", "SA_STEWARD.TNC_LANDS.MA_IFMS_ID IS NOT NULL AND SA_STEWARD.TNC_LANDS.TR_IFMS_ID IS NULL ")

# Process: MABR_NAME
arcpy.CalculateField_management(v16, "SA_STEWARD.TNC_LANDS.MABR_NAME", "[rstma1tomany.MABR_NAME]", "VB", "")
...
# Process: CLS_ACRES 
arcpy.CalculateField_management(v24, "SA_STEWARD.TNC_LANDS.CLS_ACRES", "[rstma1tomany.CLS_ACRES]", "VB", "")

# Process: Remove Join
arcpy.RemoveJoin_management(v25, "rstma1tomany")

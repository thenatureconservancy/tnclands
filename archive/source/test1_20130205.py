...
if __name__ == '__main__':
    ...
    expressions = [['NCED', '("SENSDATA" = {0}) AND ("PROTMECH" = {1}) AND ("CLSTRANSDA" < date {2})'.format(sensData, protMech[1], endDate), ['MA_IFMS_ID', 'STATE', 'OWNER', 'GAPCAT']]]
    ...
    for expression in expressions:
        ...
        try:
            ...
            arcpy.Dissolve_management(theFCLayer, outFC, expression[2], '', 'MULTI_PART')
                ...
                try:
                    ...
                    for freqRow in freqRows:
                        ...
                        for multiRow in multiRows:
                            print '{0}\t{1}\t{2}\t{3}'.format(long(multiRow.MA_IFMS_ID), multiRow.STATE, multiRow.OWNER, multiRow.GAPCAT)

...
if __name__ == '__main__':
    ...
    debug = False
    proceed = True
    PathToBackup = r'D:\GIS_Data\jplatt\Workspace\Data\NACR\TNCLands\Archive\Data\TNCLands_Backup'
    BackupGDB = 'TNC_Lands_{0}.gdb'.format(datetime.datetime.strptime(str(datetime.date.today()), "%Y-%m-%d").strftime("%Y%m%d"))
    ...
    try:
        arcpy.FeatureClassToFeatureClass_conversion("Database Connections/saeditor @ TNC_Lands_Edit.mnsde.tnc.sde/tncgdb.NACRLOADER.TNC_Lands", BackupPath, "TNC_Lands_Edit")
    except arcpy.ExecuteError:
        print arcpy.GetMessages(2)
    except Exception as e:
        print e.args[0]
    ...
    try:
        arcpy.FeatureClassToFeatureClass_conversion("Database Connections/saeditor @ TNC_Lands_Edit.mnsde.tnc.sde/tncgdb.NACRLOADER.Transferred_TNC_Lands", BackupPath, "Transferred_TNC_Lands_Edit")
    except arcpy.ExecuteError:
        print arcpy.GetMessages(2)
    except Exception as e:
        print e.args[0]
    ...
    try:
        arcpy.FeatureClassToFeatureClass_conversion("Database Connections/nacrloader @ TNC_Lands_QA.mnsde.tnc.sde/tncgdb.NACRLOADER.TNC_Lands", BackupPath, "TNC_Lands_QA")
    except arcpy.ExecuteError:
        print arcpy.GetMessages(2)
    except Exception as e:
        print e.args[0]
    ...
    try:
        arcpy.FeatureClassToFeatureClass_conversion("Database Connections/nacrloader @ TNC_Lands_QA.mnsde.tnc.sde/tncgdb.NACRLOADER.Transferred_TNC_Lands", BackupPath, "Transferred_TNC_Lands_QA")
    except arcpy.ExecuteError:
        print arcpy.GetMessages(2)
    except Exception as e:
        print e.args[0]
    ...
    try:
        arcpy.FeatureClassToFeatureClass_conversion("Database Connections/nacrloader @ default.mnsde.tnc.sde/tncgdb.NACRLOADER.TNC_Lands", BackupPath, "TNC_Lands_Default")
    except arcpy.ExecuteError:
        print arcpy.GetMessages(2)
    except Exception as e:
        print e.args[0]
    ...
    try:
        arcpy.FeatureClassToFeatureClass_conversion("Database Connections/nacrloader @ default.mnsde.tnc.sde/tncgdb.NACRLOADER.Transferred_TNC_Lands", BackupPath, "Transferred_TNC_Lands_Default")
    except arcpy.ExecuteError:
        print arcpy.GetMessages(2)
    except Exception as e:
        print e.args[0]
